...
import StarHeaderButton from "../components/HeaderButton";
...
const MealDetailedScreen = props => {
...
MealDetailedScreen.navigationOptions = (navigationData) => {
    const selectedMeal = navigationData.navigation.getParam('mealTitle');
    const isFavorite = navigationData.navigation.getParam('isFav');

    return {
        headerTitle: selectedMeal,
        headerRight: () => <HeaderButtons HeaderButtonComponent={StarHeaderButton}>
